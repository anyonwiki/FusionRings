@testset "Formatting and printing" begin
    ...
    @testset "integer formatting helpers" begin
        maybe_testset("basic", "1. basic construction") do
            ...
            check_false(isempty(t), "superscript_integer(12) returned an empty string")
        end
    ...
    @testset "row_to_string" begin
        maybe_testset("basic", "1. basic construction") do
            ...
            check_true(s isa AbstractString, "row_to_string did not return a string")
        end
    ...
    @testset "product_string" begin
        maybe_testset("basic", "1. basic construction") do
            ...
            check_false(isempty(s), "product_string(Z2, 1, 1) returned an empty string")
        end
    ...
    @testset "Base.show(::FusionRing)" begin
        maybe_testset("basic", "1. basic construction") do
            ...
            check_true(
                shown isa AbstractString,
                "show(zn_fusion_ring(2)) did not produce a string",
            )
            check_false(isempty(shown), "show(zn_fusion_ring(2)) produced an empty string")
        end
    ...
    @testset "small algebraic formatting helpers" begin
        maybe_testset("basic", "1. basic construction") do
            ...
            check_true(g1 isa Bool, "is_geometric_array([1,2,4,8]) did not return a Bool")
        end
        ...
        maybe_testset("intermediate", "2. intermediate correctness") do
            ...
            check_true(
                is_power_sum(x^2 + x + 1),
                "is_power_sum(x^2 + x + 1) should be true",
            )
            check_false(
                is_power_sum(x^2 + 2*x + 1),
