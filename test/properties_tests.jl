@testset "Properties" begin
    ...
    @testset "basic accessors" begin
        maybe_testset("basic", "1. basic construction") do
            ...
            check_true(
                names(z3) isa Vector{String},
                "names(z3) did not return a Vector{String}",
            )
            check_true(
                labels(z3) isa Vector{String},
                "labels(z3) did not return a Vector{String}",
            )
            check_true(
                tex_names(z3) isa Vector{String},
    ...
    @testset "indexmap / conjugate_element / conjugation_matrix" begin
        maybe_testset("basic", "1. basic construction") do
            ...
            check_true(c isa Int, "conjugate_element(z3, 1) did not return an Int")
        end
        ...
        maybe_testset("intermediate", "2. intermediate correctness") do
            ...
            check_equal(
                conjugate_element(z3, "0"),
                1,
                "conjugate_element(z3, \"0\") was not 1",
            )
            check_equal(
                conjugate_element(z3, "1"),
                3,
    ...
    @testset "multiplicity / nonzero structure constants" begin
        maybe_testset("basic", "1. basic construction") do
            ...
            check_true(n isa Int, "nnzsc(z3) did not return an Int")
        end
    ...
    @testset "FP dimensions" begin
        maybe_testset("basic", "1. basic construction") do
            ...
            check_true(d !== missing, "fpdim(z3) returned missing")
        end
        ...
        maybe_testset("intermediate", "2. intermediate correctness") do
            ...
            check_equal(string(fpdim(z4)), "4", "fpdim(zn_fusion_ring(4)) was not 4")
        end
    ...
    @testset "self-duality counts" begin
        maybe_testset("basic", "1. basic construction") do
            ...
            check_true(n isa Int, "nnsd(z3) did not return an Int")
        end
        ...
        maybe_testset("intermediate", "2. intermediate correctness") do
            ...
            check_equal(nnsd(z4), 2, "nnsd(zn_fusion_ring(4)) was not 2")
        end
    ...
    @testset "decompositions" begin
        maybe_testset("basic", "1. basic construction") do
            ...
            check_true(r isa Vector, "decompositions(z2) did not return a vector")
        end
    ...
    @testset "adjoint_fusion_ring / upper_central_series / is_nilpotent" begin
        maybe_testset("basic", "1. basic construction") do
            ...
            check_true(nilp isa Bool, "is_nilpotent(z3) did not return a Bool")
        end
